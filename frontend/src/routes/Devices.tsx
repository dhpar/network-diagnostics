                        ...
                        <table className="w-full">
                            <thead className="bg-gray-700">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Hostname (vendor)</th>
                            ...
                            <tbody className="divide-y divide-gray-700">
                                {data?.devices?.map((device, idx) => (
                                    <tr key={idx} className="hover:bg-gray-700 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">{Boolean(device.random_mac)? <Smartphone className='fill-transparent' /> : null}</td>
